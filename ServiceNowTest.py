    ...
    def on_pre_save(self, view):
        ...
        if settings!=False:
            ...
            if file_name in table_settings['files']:
                ...
                if result!=False:
                    add_file(file_path, result['records'][0]['sys_id'], file_name)
...
class ChangeTableConfig(sublime_plugin.WindowCommand):
    ...
    def run(self, dirs):
        ...
        self.window.show_input_panel("Display Field:", self.table_settings['display'], self.get_display_field, None, None)
    ...
    def get_extension(self,body_field):
        ...
        self.window.show_input_panel("File Extension:", self.table_settings['extension'], self.create_settings, None, None)
        return
...
class LoadAllSnowRecordCommand(sublime_plugin.WindowCommand):
    ...
    def run(self, dirs):
        self.this_dirs = dirs
        self.window.show_input_panel("Enter an encoded query (or leave blank):", "", self.get_all_records, None, None)
