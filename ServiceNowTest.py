...
def add_file(the_dir, the_id, name):
                ...
                for field in os.listdir(folder):
                    ...
                    if os.path.isdir(field_path):
                        ...
                        if os.path.isfile(file_name):
                            ...
                            # 'Check if the files are identical, if so, skip it, otherwise prompt
                            if data == doc:
                                continue
                            else:
                                if sublime.ok_cancel_dialog("File '" + name + "' already exists.\nOverwrite?") is False:
                                    continue
                ...
                if os.path.isfile(file_name):
                    ...
                    if data == doc:
                        ...
                        if delta == "":
                            ...
                            if sublime.ok_cancel_dialog("File '" + name + "' already exists, and is out of sync with the instance.\nOverwrite?") is False:
                                continue

                write_doc_file(file_name, doc)

                add_file(folder, item['sys_id'], name)
